...
OUT_DIR = Path("/home/lezahlie/src/omscs/cs7643-dl/the-space-cats-project/data/extracted")

FILES = {
    "leslie" :{
        "training": OUT_DIR / "training_outputs_best.hdf5",
        "validation": OUT_DIR  / "validation_outputs_best.hdf5",
        "testing": OUT_DIR  / "testing_outputs_best.hdf5"
    },
    "tiny" :{
    ...
    "mega" :{
        "training": OUT_DIR / "galaxiesml_mega" / "5x64x64_training_reduced_mega.hdf5",
        "validation": OUT_DIR / "galaxiesml_mega" / "5x64x64_validation_reduced_mega.hdf5",
        "testing": OUT_DIR / "galaxiesml_mega" / "5x64x64_testing_reduced_mega.hdf5"
    }
}
