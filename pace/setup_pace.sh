...
echo "transfer data: scp galaxiesml_medium.tar.gz <gtuser>@login-ice.pace.gatech.edu:$PROJECT_DIR/data/"
echo "extract data: cd $PROJECT_DIR/data && tar -xzf galaxiesml_medium.tar.gz"
echo "submit jobs: bash pace/submit_tuning.sh"
